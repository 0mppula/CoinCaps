...
function App() {
	...
	useEffect(() => {
		const getCryptoData = async () => {
			...
			const temp = [];
			// for (let i = 1; i < 5; i++) {
				let url = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=${activeCurrency.code}&order=market_cap_desc&per_page=250&page=${1}&sparkline=false&price_change_percentage=24h%2C7d`;
